...
<body>
    ...
    <center>
        ...
        <form method="POST" class="form-horizontal mt-4" action="insert.php?status=pesan">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-2">
                        <div class="col-md-12 mt-1">
                            <select class="form-select form-select-sm mt-2" aria-label=".form-select-sm example" name="nmtempat" id="nmtempat">
                                <option selected disabled class="text-center" required>~ Pilih tujuan Anda ~</option>
                                <?php
            ...
            <div class="col-sm-3">
                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="jenis_transportasi" id="jenis_transportasi">
                    <option selected disabled class="text-center" required>~ Pilih Kendaraan Anda ~</option>
                    <?php
                    include "connection.php";
